...
import gamemakerstudio_.misc.audiostuff.jzoom.dsp.KJDSPAudioDataConsumer;
import gamemakerstudio_.misc.audiostuff.jzoom.dsp.KJDigitalSignalProcessor;
import gamemakerstudio_.misc.audiostuff.jzoom.dsp.KJFFT;
...
public class VisualizerModel /*extends ResizableCanvas*/ implements KJDigitalSignalProcessor {
	...
	public VisualizerModel() {
		...
		setOscilloscopeColor(Color.WHITE);
	}
...
//	}
	 ...
	 *            the new scope color
	 */
	public synchronized void setOscilloscopeColor(Color pColor) {
